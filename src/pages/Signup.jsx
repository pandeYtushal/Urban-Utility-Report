  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="relative z-10 bg-white/10 backdrop-blur-lg
                   p-6 sm:p-8 rounded-2xl shadow-2xl
                   w-11/12 max-w-sm border border-white/20
                   hover:shadow-[0_0_25px_rgba(45,212,191,0.3)]
                   transition-all duration-300"
      >
        <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center text-teal-400">
          Create Account
        </h2>
        ...
        <div className="relative mb-5 sm:mb-6">
          <input
            ...
            className={`w-full p-3 rounded-md bg-transparent border text-white
                        ...
                        ${form.name ? "border-teal-400" : "border-gray-500"}`}
            required
          />
          <label
            htmlFor="name"
        ...
        <button
          type="submit"
          className="w-full bg-teal-600 hover:bg-teal-700 py-2.5 rounded-md font-semibold
                     text-white shadow-lg transition-all duration-200"
        >
          Sign Up
        </button>

        <p className="text-gray-300 text-sm text-center mt-4 sm:mt-5">
